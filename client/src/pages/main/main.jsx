            ...
            <div className="container px-4 py-5" id="icon-grid">
                ...
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-4">
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('spa')}>
                        <div>
                            ...
                            <img src={img_spa} className="img-fluid border border-5 rounded-3" alt="SPA"/>
                    ...
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('react')}>
                        <div>
                            ...
                            <img src={img_react} className="img-fluid border border-5 rounded-3" alt="React"/>
                    ...
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('redux')}>
                        <div>
                            ...
                            <img src={img_redux} className="img-fluid border border-5 rounded-3" alt="Redux"/>
                    ...
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('bootstrap')}>
                        <div>
                            ...
                            <img src={img_bootstrap} className="img-fluid border border-5 rounded-3" alt="Bootstrap"/>
                    ...
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('rest')}>
                        <div>
                            ...
                            <img src={img_rest} className="img-fluid border border-5 rounded-3" alt="REST API"/>
                    ...
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('mongodb')}>
                        <div>
                            ...
                            <img src={img_mongodb} className="img-fluid border border-5 rounded-3" alt="MongoDB"/>
                    ...
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('express')}>
                        <div>
                            ...
                            <img src={img_express} className="img-fluid border border-5 rounded-3" alt="Express"/>
                    ...
                    <div className={"col d-flex align-items-start rounded-2 main_panel " + getClass('node')}>
                        <div>
                            ...
                            <img src={img_node} className="img-fluid border border-5 rounded-3" alt="Node"/>
                ...
                <div className="row row-cols-2 py-4">
                    <div className="col text-center">
                        ...
                        {randomCatImage &&
                        <img src={randomCatImage} className="img-fluid border border-5 rounded-3" alt="Котик"/>}
                    </div>
                    <div className="text-center">
                        ...
                        {randomFoxImage &&
                        <img src={randomFoxImage} className="img-fluid border border-5 rounded-3" alt="Лисички"/>}
